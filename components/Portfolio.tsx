...
export default function Portfolio() {
  ...
  return <main>
    <header className="topbar">
      ...
      <div className="controls"><button className="lang-switch" onClick={()=>setLang(lang==='en'?'ar':'en')} aria-label={lang==='en'?'Switch to Arabic':'Switch to English'}>{lang==='en'?'AR':'EN'}</button><a href="mailto:alialajmi524@gmail.com">{lang==='ar'?t.talk:'Let’s talk'} ↗</a><button className="hamb" onClick={()=>setMenu(!menu)} aria-label="Menu"><i/><i/></button></div>
    </header>
